...
const getNavItems = (t: any) => [
  ...
  { key: "programs", label: t("nav.programs"), link: "/colleges-programs" },
  {
    ...
    children: [
      { key: "president-sector",   label: t("nav.presidentSector"),   link: "/sectors/president"   },
      { key: "education-sector",   label: t("nav.educationSector"),   link: "/sectors/education"   },
      { key: "community-sector",   label: t("nav.communitySector"),   link: "/sectors/community"   },
      { key: "postgraduate-sector",label: t("nav.postgraduateSector"),link: "/sectors/postgraduate"},
      { key: "secretary-sector",   label: t("nav.secretarySector"),   link: "/sectors/secretary"   },
    ],
  },
  {
    key: "students",
