...
/* ─── بيانات الكليات ─── */
const COLLEGES: Record<string, { name: string; link: string }[]> = {
  ar: [
  ...
  de: [
    ...
    { name: "Fakultät für Informatik und Information",           link: "https://www.menofia.edu.eg/FCI/Home/en" },
    { name: "Fakultät für Frühkindliche Bildung",                link: "https://mu.menofia.edu.eg/fpe/Home/en"  },
    { name: "Fakultät für Elektronisches Ingenieurwesen Menouf", link: "https://www.menofia.edu.eg/ENG/Home/en" },
    { name: "Fakultät für Angewandte Gesundheitstechnologie",    link: "https://mu.menofia.edu.eg/NCI/Home/en"  },
  ...
  fr: [
    ...
    { name: "Faculté d'Informatique et des Sciences de l'Information",       link: "https://www.menofia.edu.eg/FCI/Home/en" },
    { name: "Faculté d'Éducation de la Petite Enfance",                      link: "https://mu.menofia.edu.eg/fpe/Home/en"  },
    { name: "Faculté d'Ingénierie Électronique de Menouf",                   link: "https://www.menofia.edu.eg/ENG/Home/en" },
    { name: "Faculté de Technologie des Sciences de la Santé Appliquées",    link: "https://mu.menofia.edu.eg/NCI/Home/en"  },
...
/* ─── Helper: يجيب الـ key الصح من i18n.language ─── */
const getLangKey = (lang: string): keyof typeof COLLEGES => {
...
const CollegesPrograms: React.FC = () => {
  ...
  const colleges = COLLEGES[langKey];
